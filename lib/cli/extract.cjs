...
async function extract({ staged }) {
  ...
  // genI18nDirAndFile();
  // if (staged) {
  //   // genI18nDirAndFile()每次都会生成index.js和i18nFramework.js加入到git暂存区，操作失败也不影响后续流程
  //   addToStaged(path.resolve(i18nToolConfig.i18nDir, 'index.js'));
  //   addToStaged(path.resolve(i18nToolConfig.i18nDir, 'i18nFramework.js'));
  // }
