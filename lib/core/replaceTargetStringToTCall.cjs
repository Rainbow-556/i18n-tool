 ...
 * @param {object} options.zhMap 待处理文件的中文map
 * @param {object} options.missingEntries 待处理文件的缺失条目map
 * @returns
 */
async function replaceTargetStringToTCall({ buildTool, filePath, source, zhMap, missingEntries }) {
...
function transformCode({ buildTool, filePath, code, zhMap, langPack, missingEntries }) {
